...
org.WattDepot.Client = function(url) {
  ...
  function ajaxSend(xhr, ajaxSetting, callback, errorHandler) {
    ...
    xhr.onreadystatechange = function() {  
      if (xhr.readyState == 4) {
        if (xhr.status == 200) {
          returnThisCallback(xmlToJson(xhr.responseXML));
		}
        else {
          if (errorHandler) {
            errorHandler(xhr);
  ...
  function getAllSource(callback, errorHandler) {
    var xhr = createXmlHttpRequest();
    var setting = createGetAjaxSetting(serverUrl + "sources/?fetchAll=true");	
    ajaxSend(xhr, setting, callback, errorHandler);
  }
  ...
  function getSourceDetail(source, callback, errorHandler) {
    var xhr = createXmlHttpRequest();
    var setting = createGetAjaxSetting(serverUrl + "sources/" + source);	
    ajaxSend(xhr, setting, callback, errorHandler);
  }
  ...
  function getSourceSummary(source, callback, errorHandler) {
    var xhr = createXmlHttpRequest();
    var setting = createGetAjaxSetting(serverUrl + "sources/" + source + "/summary");	
    ajaxSend(xhr, setting, callback, errorHandler);
  }
   ...
   */
   function getSourceSensorData(source, callback, errorHandler) {
    var xhr = createXmlHttpRequest();
    var setting = createGetAjaxSetting(serverUrl + "sources/" + source + "/sensordata/");	
    ajaxSend(xhr, setting, callback, errorHandler);
  }
  ...
  function getSourceLatestSensorData(source, callback, errorHandler) {
    var xhr = createXmlHttpRequest();
    var setting = createGetAjaxSetting(serverUrl + "sources/" + source + "/sensordata/latest");	
    ajaxSend(xhr, setting, callback, errorHandler);
  }
  ...
  function getSourceSensorDataAt(source, timestamp, callback, errorHandler) {
    var xhr = createXmlHttpRequest();
    var setting = createGetAjaxSetting(serverUrl + "sources/" + source + "/sensordata/" + timestamp);	
    ajaxSend(xhr, setting, callback, errorHandler);
  }
